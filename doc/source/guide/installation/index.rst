...
:ref:`advanced-install` section.Sunpy currently supports Python 2.7 with Anaconda.
The documentation is designed for Python 2.7. Support for Python 3.x would be
coming soon.
