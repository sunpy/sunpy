...
In this example we are going to look how to use xlim
and ylim when plotting Map with WCSAxes.
"""
...
###############################################################################
# Lets start by creating a Map from the sample data and plotting it.
...
# of interest and then plotting that. Another useful way is to just set the axes
# range over which to plot using Matplotlib's xlim and ylim functions.
...
###############################################################################
# We can then covert these into a SkyCoord which can be passed to Map.world_to_pixel to
