...
plt.plot(
    noaa_predict.data.index,
    noaa_predict.data["sunspot"],
    color="grey",
    label="Near-term Prediction",
)
plt.fill_between(
    noaa_predict.data.index,
    noaa_predict.data["sunspot low"],
    noaa_predict.data["sunspot high"],
    alpha=0.3,
    color="grey",
)
plt.fill_between(
    noaa2.data.index,
    noaa2.data["sunspot RI smooth"] * 0.8,
    noaa2.data["sunspot RI smooth"] * 1.2,
    alpha=0.3,
    color="grey",
