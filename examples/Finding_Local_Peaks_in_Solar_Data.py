...
This example illustrates detection of those areas where there is a spike in solar radiation intensity.
We use the peak_local_max function under the scikit library to find those regions in the map
data where the intensity values form a local maxima.
