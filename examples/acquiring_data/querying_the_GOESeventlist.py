...
###################################################################
# The result is returned as a `Table <sunpy.net.hek.hek.HEKTable>`.
...
###################################################################
# The results returned to the `Table <sunpy.net.hek.hek.HEKTable>`
# contain alot of information and we may only want to keep some main
# results such as start time, end time, peak time, GOES-class, active
# region number. This can be done as so:
