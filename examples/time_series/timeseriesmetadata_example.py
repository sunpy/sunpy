...
norh_res = Fido.search(
    a.Time("2010-11-02", "2010-11-07"), a.Instrument("norh"), a.Wavelength(17 * u.GHz)
)
##############################################################################
...
large_trunc_ts = large_ts.truncate(
    TimeRange("2010-11-03 13:59:57.468999", "2010-11-05 13:59:56.091999")
)
