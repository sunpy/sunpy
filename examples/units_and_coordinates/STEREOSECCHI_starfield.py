...
How to use the Vizier star catalog to identify bright points in a
STEREO/SECCHI COR 2 image as stars. As a bonus, we also identify Mars.
"""
...
###############################################################################
# Let's download a STEREO-A SECCHI COR2 image from Helioviewer which provided
...
# astroquery. We will search the GAIA2 star catalog and only stars with magnitude
# brighter than 7.
...
for this_object in result[0]:
    ...
    hpc_coords.append(tbl_crds.transform_to(frames.Helioprojective(observer=cor2.observer_coordinate)))
