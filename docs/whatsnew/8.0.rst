...
.. code-block:: python
    ...
    >>> time = a.Time("2021-02-01", "2021-02-01T02:00:00")
    >>> level = a.Level(1)
    >>> product = a.soar.Product("EUI-FSI174-IMAGE")

    >>> Fido.search(instrument & time & level & product)  # doctest: +REMOTE_DATA
    <sunpy.net.fido_factory.UnifiedResponse object at 0x7fbd78975610>
    ...
    ---------- ---------------- ----- ----------------------- ----------------------- -------- --------- -------- ----------
           ...
           EUI eui-fsi174-image    L1 2021-02-01 01:15:12.232 2021-02-01 01:15:22.232    0.418      none      FSI      174.0
           EUI eui-fsi174-image    L1 2021-02-01 01:45:12.237 2021-02-01 01:45:22.237    0.406      none      FSI      174.0
   <BLANKLINE>
   <BLANKLINE>
