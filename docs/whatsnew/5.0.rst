...
The new structure has four major distinct sections:

- :ref:`tutorial`, a step-by-step introduction to sunpy.
- :ref:`how_to_guide`, a set of small self contained guides to getting specific tasks done.
- :ref:`guide`, a set of more in depth guides that explain how and why different parts of sunpy work.
