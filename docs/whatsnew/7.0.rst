...
There is now support for PUNCH level 3 products within sunpy.

.. image:: 7.0-punch.png
   :alt: A plot from sunpy of a PUNCH level 3 file.

Solar Ultraviolet Imaging Telescope (SUIT) map source
=====================================================

SUIT level 1 products onboard the Aditya-L1 mission are now supported in sunpy.


SOHO's Extreme ultraviolet Imaging Telescope (EIT) map source
=============================================================

There was previously support for older SOHO/EIT files, but now there is also support
for SOHO/EIT level 1 files.

Global Oscillation Network Group (GONG) magnetogram map source
==============================================================

Formal support for GONG magnetograms has been added to sunpy.
