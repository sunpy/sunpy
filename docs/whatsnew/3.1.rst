...
This allows search for and downloading data from many space physics missions that take in-situ data (including Parker Solar Probe and Solar Orbiter).
...
See :ref:`sphx_glr_examples_acquiring_data_search_cdaweb.py` for a full example.
