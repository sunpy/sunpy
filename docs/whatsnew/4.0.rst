...
Deprecation of `sunpy.fits.io`
==============================
The `sunpy.io.fits` module is deprecated, and will be removed in verison 4.1.
...
The `astropy.fits.io` module can be used instead as a replacement that is designed to be user-facing.
