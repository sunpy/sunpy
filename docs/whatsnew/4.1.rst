...
======================================
The structure of the sunpy core documentation has been updated to distinguish between:

- "how-to" examples that are each tailored towards accomplishing a single task.
  These are in the pre-existing examples gallery.
- Tutorials that are longer and give a step by step lesson in how to use a particular part of sunpy.
