...
Now the "all" extra group is a meta group that includes all optional dependencies.

We have removed the "dask" extra group and we have removed "scikit-image" from the "image" extra group and added it a new group called "scikit-image".
