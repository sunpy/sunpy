...
This release of ``sunpy`` contains 764 commits in 173 merged pull requests closing 67 issues from 33 people, 15 of which are first-time contributors to ``sunpy``.

* 764 commits have been added since 5.1
* 67 issues have been closed since 5.1
* 173 pull requests have been merged since 5.1
