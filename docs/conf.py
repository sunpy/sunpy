...
try:
    ...
    print(
        "ERROR: zeep could not be imported. Building the documentation requires "
...
try:
    ...
    print(
        "ERROR: skimage could not be imported. Building the documentation requires "
...
try:
    ...
    print(
        "ERROR: drms could not be imported. Building the documentation requires "
...
try:
    ...
    print(
        "ERROR: glymur could not be imported. Building the documentation requires "
...
try:
    ...
    html_context = {"sunpy_modules": sunpy_modules}
    ...
    html_context = {}
    print(
        "Warning: Stability of SunPy API page of the documentation requires the ruamel.yaml package to be installed"
    )
...
if has_sphinx_gallery:
    ...
    sphinx_gallery_conf = {
        ...
        "subsection_order": ExplicitOrder(
            [
                (os.path.join("..", "examples/acquiring_data")),
