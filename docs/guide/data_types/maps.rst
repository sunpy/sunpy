...
user, and contains information on the reference coordinate, the required WCS meta and the observer location. The function returns a `sunpy.utils.MetaDict <sunpy.utils.MetaDict>`.
