...
class LYRALightCurve(LightCurve):
    ...
    has sub-second resolution or Level 3 data which has one minute resolution.
    The level can be specified with the ``level`` keyword argument to
    `~sunpy.lightcurve.LyraLightCurve.create`.
