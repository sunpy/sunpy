...
def draw_limb(axes, observer, *, rsun=R_sun, resolution=1000, **kwargs):
    """
    ...
    of the limb is different from the coordinate frame of the plot axes, not
    only may the limb not be a true circle, a portion of the limb may be hidden
    from the observer.  In that case, the circle is divided into visible and
    hidden segments, represented by solid and dotted lines, respectively.
    ...
    rsun : `~astropy.units.Quantity`
        Solar radius at which to draw the limb. Defaults to the standard
        photospheric radius.
    resolution : `int`
