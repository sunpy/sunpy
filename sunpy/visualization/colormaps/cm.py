...
cmlist = {
    ...
    'solar orbitermetisvl-tb': ct.metis_color_table('solar orbitermetisvl-tb'),
    'solar orbitermetisvl-pb': ct.metis_color_table('solar orbitermetisvl-pb'),
    'solar orbitermetisvl-fp': ct.metis_color_table('solar orbitermetisvl-fp'),
    'solar orbitermetisvl-pa': ct.metis_color_table('solar orbitermetisvl-pa'),
    'solar orbitermetisvl-si': ct.metis_color_table('solar orbitermetisvl-si'),
    'solar orbitermetisvl-sq': ct.metis_color_table('solar orbitermetisvl-sq'),
    'solar orbitermetisvl-su': ct.metis_color_table('solar orbitermetisvl-su'),
    'solar orbitermetisvl-pq': ct.metis_color_table('solar orbitermetisvl-pq'),
    'solar orbitermetisvl-ae': ct.metis_color_table('solar orbitermetisvl-ae'),
    'solar orbitermetisuv': ct.metis_color_table('solar orbitermetisuv'),
    'solar orbitermetisuv-pq': ct.metis_color_table('solar orbitermetisuv-pq'),
    'solar orbitermetisuv-ae': ct.metis_color_table('solar orbitermetisuv-ae'),
