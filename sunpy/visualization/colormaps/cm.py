...
cmlist = {
    ...
    'solometisvl-tb': ct.metis_color_table('solometisvl-tb'),
    'solometisvl-pb': ct.metis_color_table('solometisvl-pb'),
    'solometisvl-fp': ct.metis_color_table('solometisvl-fp'),
    'solometisvl-pa': ct.metis_color_table('solometisvl-pa'),
    'solometisvl-si': ct.metis_color_table('solometisvl-si'),
    'solometisvl-sq': ct.metis_color_table('solometisvl-sq'),
    'solometisvl-su': ct.metis_color_table('solometisvl-su'),
    'solometisvl-pq': ct.metis_color_table('solometisvl-pq'),
    'solometisvl-ae': ct.metis_color_table('solometisvl-ae'),
    'solometisvl-re': ct.metis_color_table('solometisvl-re'),
    'solometisuv': ct.metis_color_table('solometisuv'),
    'solometisuv-pq': ct.metis_color_table('solometisuv-pq'),
    'solometisuv-ae': ct.metis_color_table('solometisuv-ae'),
    'solometisuv-re': ct.metis_color_table('solometisuv-re'),
