...
'http://stereo-ssc.nascom.nasa.gov/data/ins_data/plastic/level2/Protons/Derived_from_1D_Maxwellian/ASCII/10min/A/2009/STA_L2_PLA_1DMax_10min_20090301_060_V09.txt',
'http://stereo-ssc.nascom.nasa.gov/data/ins_data/plastic/level2/Protons/Derived_from_1D_Maxwellian/ASCII/10min/A/2009/STA_L2_PLA_1DMax_10min_20090402_092_V09.txt'),
(TimeRange('2009/03/01', '2009/04/02'),'behind', 1*u.h,
'http://stereo-ssc.nascom.nasa.gov/data/ins_data/plastic/level2/Protons/Derived_from_1D_Maxwellian/ASCII/1hr/B/2009/STB_L2_PLA_1DMax_1hr_20090301_060_V09.txt',
'http://stereo-ssc.nascom.nasa.gov/data/ins_data/plastic/level2/Protons/Derived_from_1D_Maxwellian/ASCII/1hr/B/2009/STB_L2_PLA_1DMax_1hr_20090402_092_V09.txt')
])
...
@pytest.mark.online
def test_query():
    qr1 = LCClient.query(Time('2012/8/9', '2012/8/10'), Instrument('stereo/plastic'), stereo_spacecraft = 'ahead', duration_of_average = 10*u.min)
    assert isinstance(qr1,QueryResponse)
    assert len(qr1) == 2
    assert qr1.time_range().start == datetime(2012,8,9)
    assert qr1.time_range().end == datetime(2012,8,10)

@pytest.mark.online
@pytest.mark.parametrize("time, instrument, stereo_spacecraft, duration_of_average",
[(Time(TimeRange('2012/11/27', '2012/11/27')), Instrument('stereo/plastic'), 'ahead', 10*u.min),
 (Time(TimeRange('2012/10/4', '2012/10/6')), Instrument('stereo/plastic'),'behind', 1*u.h),
])
