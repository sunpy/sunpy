...
@pytest.mark.parametrize("timerange,url_start,url_end",
                         [(TimeRange('2011/06/07', '2011/06/09'),
                          'https://heasarc.gsfc.nasa.gov/FTP/fermi/data/gbm/daily/2011/06/07/current/\
                          glg_cspec_n5_110607_v00.pha',
                           ...
                           current/glg_cspec_n5_110609_v00.pha'),
                             (TimeRange('2017/09/09', '2017/09/11'),
                              'https://heasarc.gsfc.nasa.gov/FTP/fermi/data/gbm/daily/2017/09/09/current/\
                            glg_cspec_n5_170909_v00.pha',
                                 'https://heasarc.gsfc.nasa.gov/FTP/fermi/data/gbm/daily/2017/09/11/current/\
                            glg_cspec_n5_170911_v01.pha')])
