...
@mock.patch(
    "sunpy.net.dataretriever.sources.rhessi.get_base_url", return_value="http://www.example.com"
)
def test_get_observing_summary_dbase_file_build_correct_url(
    mock_get_base_url, mock_urlretrieve, one_day_timerange
):
    """
...
@mock.patch(
    "sunpy.net.dataretriever.sources.rhessi.RHESSIClient.get_observing_summary_dbase_file",
    return_value=("", {}),
)
def test_get_observing_summary_filename_one_day(
    mock_get_observing_summary_dbase_file,
...
def test_get_observing_summary_filename_two_days(
    mock_get_observing_summary_dbase_file,
    mock_parse_observing_summary_dbase_file,
    mock_get_base_url,
):
