...
class NoRHClient(GenericClient):
    ...
    Uses this `ftp archive <ftp://nsro-archive.nro.nao.ac.jp/pub/nsro/norh/data/tcx/>`__
    ...
    <BLANKLINE>
    """
    baseurl = r'ftp://nsro-archive.nro.nao.ac.jp/pub/nsro/norh/data/tcx/%Y/%m/(\w){3}%y%m%d'
