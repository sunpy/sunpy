...
def create_url(date, wavelength):
    ...
    base = f"ftp://nsro-archive.nro.nao.ac.jp/pub/nsro/norh/data/tcx/{year}/{month}/{freq}{value_}"
    return (base)
...
@pytest.mark.parametrize(("timerange", "url_start", "url_end"), [
    (a.Time('2012/4/21', '2012/4/21'),
     'ftp://nsro-archive.nro.nao.ac.jp/pub/nsro/norh/data/tcx/2012/04/tca120421',
     'ftp://nsro-archive.nro.nao.ac.jp/pub/nsro/norh/data/tcx/2012/04/tca120421'
     ),
    (a.Time('2012/12/1', '2012/12/2'),
     'ftp://nsro-archive.nro.nao.ac.jp/pub/nsro/norh/data/tcx/2012/12/tca121201',
     'ftp://nsro-archive.nro.nao.ac.jp/pub/nsro/norh/data/tcx/2012/12/tca121202'
     ),
    (a.Time('2012/3/7', '2012/3/14'),
     'ftp://nsro-archive.nro.nao.ac.jp/pub/nsro/norh/data/tcx/2012/03/tca120307',
     'ftp://nsro-archive.nro.nao.ac.jp/pub/nsro/norh/data/tcx/2012/03/tca120314'
     )
])
