...
def test_post_notify_fail():
    responses = client.search(
        vso_attrs.Time("2012/1/1T00:00:00", "2012/1/1T00:00:45"), attrs.Series("hmi.M_45s")
    )
...
def test_lookup_records_errors():
    d1 = {
        "end_time": astropy.time.Time("2014-01-01 01:00:35"),
...
def test_make_recordset():
    ...
    exp = (
        "hmi.sharp_720s[4864][2014.01.01_00:00:35_TAI-2014.01.01_01:00:35_TAI]"
    ...
    exp = (
        "hmi.sharp_720s[][2014.01.01_00:00:35_TAI-2014.01.01_01:00:35_TAI@300.0s]"
        "{continuum,magnetogram}"
    )
    assert client._make_recordset(**d1) == exp
