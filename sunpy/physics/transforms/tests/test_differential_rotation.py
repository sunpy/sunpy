...
import pytest
import numpy as np
from sunpy.physics.transforms.differential_rotation import diff_rot, sun_pos, calc_P_B0_SD, rot_hpc
...
class TestDiffRot():
    ...
    def test_rot_hpc(self):
        ...
        np.testing.assert_almost_equal(x, 573.9, decimal=1)
        np.testing.assert_almost_equal(y, -108.3, decimal=1)
