...
def calculate_solar_rotate_shift(mc, layer_index=0, **kwargs):
    ...
    layer_index : int
        ...
        this layer.
    **kwargs
        Keyword arguments for the solar rotation calculation.
...
def mapcube_solar_derotate(mc, layer_index=0, clip=True, shift=None, **kwargs):
    ...
    **kwargs
    ...
    for i, m in enumerate(mc):
        xshift_keep[i] = u.pix * xshift_arcseconds[i].value / m.scale['x']
        yshift_keep[i] = u.pix * yshift_arcseconds[i].value / m.scale['y']
