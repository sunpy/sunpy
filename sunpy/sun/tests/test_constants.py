...
@pytest.mark.parametrize('this_constant', [value for key, value in con.constants.iteritems()])
...
@pytest.mark.parametrize('this_key', [key for key, value in con.constants.iteritems()])
