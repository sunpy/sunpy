...
def B0(time='now'):
    ...
    heliographic latitude of the of the center of the disk of the Sun as seen
    from Earth. The range of B0 is +/-7.23 degrees.
...
def L0(time='now',
    ...
    """
    Return the L0 angle for the Sun at a specified time, which is the apparent
