...
# Add shortcuts so that GEI transforms to/from heliospheric frames go through HME
...
# Add shortcuts so that GEI transforms to/from CIRS-based frames go through GCRS
