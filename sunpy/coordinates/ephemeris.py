...
def get_body_heliographic_stonyhurst(body, time='now', observer=None, *, include_velocity=False):
    ...
    in order to change the ephemeris. You can refer
    `astropy.coordinates.solarsystem <https://docs.astropy.org/en/stable/coordinates/solarsystem.html>`__ for docs.
