    ...
    def _parse_args(self, *args, **kwargs):
        ...
        * lists containing any of the above.
        ...
        while i < len(args):
            ...
            if ((type(arg) in [tuple, list]) and len(arg) == 2 and isinstance(arg[0], np.ndarray) and
...
Map = MapFactory(default_widget_type=GenericMap, additional_validation_functions=['is_datasource_for'])
