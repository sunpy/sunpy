...
class MDISynopticMap(MDIMap):
    ...
    A synoptic map is an attempt to represent full surface of the Sun but 
    using only observations from the Earth’s viewing direction. 
    ...
    and longitudes. Once the area of synoptic map disappears behind 
    solar limb, it does not change anymore until the area re-appears 
