...
@pytest.fixture
def composite_test_map(aia171_test_map, hmi_test_map_modified):
    return sunpy.map.Map(aia171_test_map, hmi_test_map_modified, composite=True)


@pytest.fixture
def composite_test_map_prealigned(aia171_test_map, hmi_test_map_modified):
    hmi_test_map_reprojected = hmi_test_map_modified.reproject_to(aia171_test_map.wcs)
    return sunpy.map.Map(aia171_test_map, hmi_test_map_reprojected, composite=True)
