...
class TestMap:
    ...
    def test_databaseentry(self):
        db = sunpy.database.Database(url='sqlite://',
...
#==============================================================================
    ...
    def test_sot(self):
        #Test SOTMap
        sot = sunpy.map.Map(os.path.join(filepath,
