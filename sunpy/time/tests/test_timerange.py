...
class TestTimeRange(object):
    ...
    def test_split_n_0_error(self, timerange_a):
        with pytest.raises(ValueError):
            timerange_a.split(n=0)

    def test_input_error(self, timerange_a):
        with pytest.raises(ValueError):
    ...
    def test_window_timedelta(self, timerange_a):
        timerange = sunpy.time.TimeRange(tbegin_str,tfin_str)
    ...
    def test_days(self, timerange_a):
        assert timerange_a.days == Quantity(1, 'd')
    
    def test_start(self, timerange_a):
        assert timerange_a.start == start
    
    def test_end(self, timerange_a):
        assert timerange_a.end == end
    
    def test_seconds(self, timerange_a):
        assert timerange_a.seconds == dt
    
    def test_minutes(self, timerange_a):
        assert timerange_a.minutes == Quantity(24 * 60, 'min')
        
    def test_hours(self, timerange_a):
    ...
    def test_contains(self, timerange_a):
