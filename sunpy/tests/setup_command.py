...
class SunPyTest(AstropyTest):
    ...
    user_options += [
        ...
        ("figure", None, "Run the figure tests."),
        # Run only tests that check figure generation
        ("figure-only", None, "Only run tests that compare figures against stored hashes."),
    ]
    ...
    def _generate_coverage_commands(self):
        ...
        cwd = os.path.abspath(".")
        cmd_post = (
            "from sunpy.tests.helpers import _patch_coverage; "
            "import os; "
