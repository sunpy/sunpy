...
def read(cls, filename, **kwargs):
    """ Reads in a given FITS file and returns a new EISSpectrogram. Additional
    parameters are given to fits.open.
    ...
    return EISSpectrogram(cubes=cubes, wavelengths=wavelengths,
                          dataHeader=hdulist[1].header, primaryHeader=header)


class EISSpectrogram(LinearTimeSpectrogram): # TODO: should this be a spectrogram? Ask David.
