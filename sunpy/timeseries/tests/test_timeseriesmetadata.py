...
def test_find_both_filters(basic_2_md, basic_4_md, complex_append_md):
    assert (
        complex_append_md.find(time="2010-01-02 20:59:57.468999", colname="column2") == basic_2_md
    )
    assert (
        complex_append_md.find(time="2010-01-02 20:59:57.468999", colname="md4_column1")
        == basic_4_md
    )
...
def test_get_time_filter(complex_append_md):
    assert complex_append_md.get("md1_key1", time="2010-01-01 20:59:57.468999").values() == [
        "value1"
    ]
    assert complex_append_md.get("md2_key2", time="2010-01-02 20:59:57.468999").values() == [
        "value2"
    ]
    assert complex_append_md.get("all_same", time="2010-01-01 20:59:57.468999").values() == [
        "value3"
    ]
    assert complex_append_md.get("all_different", time="2010-01-01 20:59:57.468999").values() == [
        "diff_1",
        "diff_4",
    ]
...
def test_get_colname_filter(complex_append_md):
    ...
    assert complex_append_md.get("all_different", colname="column1").values() == [
        "diff_1",
        "diff_2",
        "diff_3",
    ]
...
def test_get_both_filters(complex_append_md):
    assert complex_append_md.get(
        "all_different", time="2010-01-02 20:59:57.468999", colname="column2"
    ).values() == ["diff_2"]
...
def test_update_time_filter(complex_append_md):
    ...
    assert (
        updated_md.metadata[0][2]["all_same"] == updated_md.metadata[1][2]["all_same"] == "updated"
    )
    assert (
        updated_md.metadata[2][2]["all_same"] == updated_md.metadata[3][2]["all_same"] == "value3"
    )
...
def test_update_colname_filter(complex_append_md):
    ...
    assert (
        updated_md.metadata[0][2]["all_same"]
        == updated_md.metadata[2][2]["all_same"]
        == updated_md.metadata[3][2]["all_same"]
        == "updated"
    )
...
def test_update_both_filters(complex_append_md):
    ...
    updated_md.update(
        {"all_same": "updated"},
        colname="column1",
        time="2010-01-01 23:59:57.468999",
        overwrite=True,
    )
    assert updated_md.metadata[0][2]["all_same"] == "updated"
    assert (
        updated_md.metadata[1][2]["all_same"]
        == updated_md.metadata[2][2]["all_same"]
        == updated_md.metadata[3][2]["all_same"]
        == "value3"
    )
...
def test_rename_column(complex_append_md):
    ...
    assert (
        col_renamed_md.metadata[0][1][0]
        == col_renamed_md.metadata[2][1][0]
        == col_renamed_md.metadata[3][1][0]
        == new
    )
...
def test_remove_column(complex_append_md):
    ...
    assert (
        col_removed_md.metadata[0][1]
        == col_removed_md.metadata[2][1]
        == col_removed_md.metadata[3][1]
...
def test_remove_columns(complex_append_md):
    ...
    assert (
        cols_removed_md.metadata[0][1]
        == cols_removed_md.metadata[2][1]
        == cols_removed_md.metadata[3][1]
        == [complex_append_md.metadata[0][1][1]]
    )
