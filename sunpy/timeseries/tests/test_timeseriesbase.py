...
def test_units_type(eve_test_ts, fermi_gbm_test_ts, norh_test_ts, goes_test_ts, lyra_test_ts, rhessi_test_ts,
                    noaa_ind_test_ts, noaa_pre_test_ts, generic_ts, table_ts):
...
def test_meta_type(eve_test_ts, fermi_gbm_test_ts, norh_test_ts, goes_test_ts, lyra_test_ts, rhessi_test_ts,
                   noaa_ind_test_ts, noaa_pre_test_ts, generic_ts, table_ts):
...
def test_data_type(eve_test_ts, fermi_gbm_test_ts, norh_test_ts, goes_test_ts, lyra_test_ts, rhessi_test_ts,
                   noaa_ind_test_ts, noaa_pre_test_ts, generic_ts, table_ts):
...
def test_column_quantity(eve_test_ts, column_quantity):
    ...
    assert ((eve_test_ts.data['CMLon'].values == column_quantity.value) |
            (np.isnan(eve_test_ts.data['CMLon'].values) & np.isnan(column_quantity.value))).all()
