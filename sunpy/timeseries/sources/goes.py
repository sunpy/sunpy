    ...
    * https://umbra.nascom.nasa.gov/goes/fits/goes_fits_files_notes.txt
    ...
    def peek(self, title="GOES Xray Flux"):
        ...
        **kwargs : `dict`
        ...
        axes.plot_date(dates, self.data["xrsa"], "-", label=r"0.5--4.0 $\AA$", color="blue", lw=2)
        axes.plot_date(dates, self.data["xrsb"], "-", label=r"1.0--8.0 $\AA$", color="red", lw=2)
    ...
    def _parse_hdus(cls, hdulist):
        ...
        data = DataFrame({"xrsa": newxrsa, "xrsb": newxrsb}, index=times.isot.astype("datetime64"))
