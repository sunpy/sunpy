`sunpy.map.GenericMap.contour` now uses ContourPy instead of scikit-image for faster performance and consistency with `draw_contour`, reducing reliance on scikit-image.
